...
export default function Aside(props){
  ...
  const themes = [    
      ...
      {key:3 ,image:images.themeBlackLight, theme: function(){ props.changeColor("#E5E5E5" , "#14213d" , "#14213d93" ) } ,},
      ...
      {key:6 ,image:images.themeGreenLight, theme: function(){ props.changeColor("#FFFEFD" , "#5D2A42" , "#5D2A4293" ) } ,},
      ...
      {key:13 ,image:images.themeMaterialLight , theme: function(){ props.changeColor("#ffffff" , "#4c2b91" , "#4c2b9193" ) } ,},
      {key:14 ,image:images.themeMaterialTealLight , theme: function(){ props.changeColor("#ffffff" , "#05505E" , "#05505E93" ) } ,},
    ] 
    return(
